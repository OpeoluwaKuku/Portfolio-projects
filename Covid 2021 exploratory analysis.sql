...
--THE COUNTRIES WITH THE HIGHEST TOTAL AND PERCENTAGE OF VAXED POPULATION

WITH POPvsVAC (continent, location, population, Sum_of_vaccinations)
as
(
...
SELECT *, (Sum_of_vaccinations/population)*100 as Percentage_of_vaxed_population
FROM POPvsVAC
ORDER BY 1, 2
